...
namespace WCF
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "IBanDiaServices" in both code and config file together.
    [ServiceContract]
    public interface IBanDiaServices
    {
        [OperationContract]
