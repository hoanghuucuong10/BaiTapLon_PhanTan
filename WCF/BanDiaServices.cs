...
namespace WCF
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "BanDiaServices" in both code and config file together.
    public class BanDiaServices : IBanDiaServices
    {
